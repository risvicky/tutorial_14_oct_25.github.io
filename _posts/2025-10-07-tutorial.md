...
You can also download the [empty.gro]({{ '/file/empty.gro' | relative_url }}) and save it in the same folder.
...
You can also download the [no3.gro]({{ '/file/no3.gro' | relative_url }}) and save it in the same folder.
...
1
   ...
   1.00000   1.00000   1.00000
   ```
You can also download the [na.gro]({{ '/file/na.gro' | relative_url }}) and save it in the same folder.
...
If you are unable to insert the molecules, you can download the [conf.gro]({{ '/file/conf.gro' | relative_url }}) file to continue the tutorial.
...
nstxout = 10
```
You can also download the [min.mdp]({{ '/file/min.mdp' | relative_url }}).
...
You can also download the [nvt.mdp]({{ '/file/nvt.mdp' | relative_url }})
...
```
You can also download the [npt.mdp]({{ '/file/npt.mdp' | relative_url }})
