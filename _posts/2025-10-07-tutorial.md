...
xmgrace min_pe.xvg
```
![min_pe](/figure/min_pe.png){: width="400" height="auto" .center}

The system should be stable enough for the MD simulation.

## 4. **Equilibration**
#### Running equilibration steps under *NVT* and *NPT* ensembles.
...
The temperature should reach 360 K and checking it using the command.
```
